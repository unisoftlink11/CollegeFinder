  ...
  <thead>
    <tr>
      ...
      <th scope="col">Link</th>
       <td colspan="2" align="center"><a href="insert_bim.jsp" class="btn btn-primary">Insert</a></td>
    </tr>
  </thead>
</tbody>
<%
...
<td><%= user.getLink() %></td>
<td><a href="UserHandler?command=delete_bim&id=<%=user.getId()%>" class="btn btn-danger">Delete</a></td>
<td><a href="UserHandler?command=editform_bim&id=<%=user.getId() %>" class="btn btn-dark">Update</a></td>
</tr>
<%
}
%>
