...
<body>
	...
	<%
    DAO dao = new DAO();
	List<CollegeModel> scholarBca = (ArrayList<CollegeModel>)request.getAttribute("collegemodel");
	List<scholarshipafteradmission> scholar_Bca = (ArrayList<scholarshipafteradmission>)request.getAttribute("collegemode");;
...
<h3>Scholarship Before Admission</h3>
 ...
 <%
for(CollegeModel collegemodel2: scholarBca){
%>


<td><%=collegemodel2.getId() %>
<td><%= collegemodel2.getHseb()%></td>
<td><%= collegemodel2.getAdmissionFee() %></td>
<td><%= collegemodel2.getSemesterFee() %></td>
</tr>
...
<h3>Scholarship After Admission</h3>
 ...
 <%
for(scholarshipafteradmission saa2: scholar_Bca){
%>
<td><%=saa2.getId() %>
<td><%= saa2.getFirst()%></td>
<td><%= saa2.getSecond() %></td>
<td><%= saa2.getThird() %></td>
</tr>
