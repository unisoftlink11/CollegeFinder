...
<html lang="en">
<head>
<title>Scholarship_Bsccsit</title>
<meta charset="utf-8">
...
<body>
	...
	<%
    DAO dao = new DAO();
   List<CollegeModel> collegeList = (ArrayList<CollegeModel>)request.getAttribute("collegemodel");
   List<scholarshipafteradmission> scholarList = (ArrayList<scholarshipafteradmission>)request.getAttribute("collegemode");
...
<h3>Scholarship Before Admission</h3>
 ...
 <%
for(CollegeModel collegemodel: collegeList){
%>


<td><%=collegemodel.getId() %>
<td><%= collegemodel.getHseb()%></td>
<td><%= collegemodel.getAdmissionFee() %></td>
<td><%= collegemodel.getSemesterFee() %></td>
</tr>
...
<h3>Scholarship After Admission</h3>
 ...
 <%
for(scholarshipafteradmission saa: scholarList){
%>
<td><%=saa.getId() %>
<td><%= saa.getFirst()%></td>
<td><%= saa.getSecond() %></td>
