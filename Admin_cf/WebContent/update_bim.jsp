...
<h1>Update Form for <span>BIM</span></h1><hr>
<form method="POST" action="UserHandler" name = "editform_bim">
<input type="hidden" name="command" value="update_bim">
<%
String uid = request.getParameter("id");
if(!(uid == null)){
	int id = Integer.parseInt(uid);
	user= dao.getUserById2(id);
%>
